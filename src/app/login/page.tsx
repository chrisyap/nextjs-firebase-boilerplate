...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-6">
      <div className="w-full max-w-sm rounded-lg bg-stone-800 p-8 shadow-xl shadow-black">
        ...
        <Input
          ...
          className="mb-4 w-full rounded-md bg-gray-700 px-4 py-2 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none"
        />
        <Input
          type="password"
          value={password}
